...
public class TestRateLimiter {
    ...
    public void testRateLimiter2() throws InterruptedException {
        ...
        double cost = rateLimiter.acquire(3);
        System.out.println("获取3个令牌结束，时间为" + FORMATTER.format(new Date()) + ", 耗时" + cost + "ms");

        System.out.println("获取4个令牌开始，时间为" + FORMATTER.format(new Date()));
        cost = rateLimiter.acquire(4);
        System.out.println("获取4个令牌结束，时间为" + FORMATTER.format(new Date()) + ", 耗时" + cost + "ms");
